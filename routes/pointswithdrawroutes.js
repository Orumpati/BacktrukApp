...
router.post('/pointsPost',jwtAuth.verifyToken,checkSubscription, async(req, res, next) => {        // want to create product details
...
auth:{
    ...
    router.post('/reqestedHistory',jwtAuth.verifyToken,checkSubscription, (req, res, next) => {
